...
const PrivacyPolicy = () => {
    return (
        <div className='p-5'>
            ...
            <p>The app does use third party services that may collect information used to identify you.</p> <div><p>Link to privacy policy of third party service providers used by the app</p>
                <ul>
            ...
            <p>This privacy policy page was created at <Link to="/contact_us" target="_blank" rel="noopener noreferrer">  CONTACT US  </Link>
                and modified/generated by
                 <a href="https://project-ema-john.web.app/" target="_blank" rel="noopener noreferrer">  Website
